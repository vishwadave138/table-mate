    ...
    <div>
      ...
      <section class="text-gray-600 body-font flex">
        <div class="container px-5 py-24 mx-auto"> 
          <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            <div class="flex-grow sm:text-right text-center mt-6 sm:mt-0">
              ...
              Lorem Ipsum is simply dummy printing and typeset industry lorem Ipsum has been.
              </p>
              
            </div>
            <div class=" sm:order-none order-first sm:w-20 sm:h-20 h-20 w-20 sm:ml-10 inline-flex hover:skew-y-12 items-center justify-center rounded-full bg-gray-600 text-orange-300 shadow-zinc-700 shadow-2xl flex-shrink-0">
              <svg
                fill="none"
                stroke="currentColor"
          ...
          <div class="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col">
            <div class="sm:w-20 sm:h-20 h-20 w-20 sm:mr-10 inline-flex hover:skew-y-12 items-center justify-center rounded-full bg-gray-600 text-orange-300 shadow-zinc-700 shadow-2xl flex-shrink-0">
              <svg
                fill="none"
                stroke="currentColor"
                stroke-linecap="round"
        ...
        <div class=" px-1 py-24 mx-auto"> 
          <img src="https://i.pinimg.com/originals/b0/fd/ec/b0fdecb62b32352777d30ae55cc762f7.jpg" alt='pic' className="h-full"/>
        </div>
        ...
        <div class="container px-5 py-24 mx-auto"> 
          <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div class=" sm:order-none order-first hover:skew-y-12 sm:w-20 sm:h-20 h-20 w-20 sm:ml-10 inline-flex items-center justify-center rounded-full bg-gray-600 text-orange-300 shadow-zinc-700 shadow-2xl flex-shrink-0">
              <svg
                fill="none"
                stroke="currentColor"
                stroke-linecap="round"
          ...
          <div class="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col">
            <div class="sm:w-20 sm:h-20 h-20 w-20 hover:skew-y-12 sm:mr-10 inline-flex items-center justify-center rounded-full bg-gray-600 text-orange-300 shadow-zinc-700 shadow-2xl flex-shrink-0">
              <svg
                fill="none"
                stroke="currentColor"
                stroke-linecap="round"
      ...
      <h3 className="text-4xl font-bold mt-8 text-amber-700">TESTIMONIALS</h3>
      <h1 className="text-5xl font-mono mt-8 text-gray-600">
