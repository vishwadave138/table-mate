    ...
    <div>
      ...
      <section class="text-gray-600 body-font ">
        ...
        <button
          ...
          class="border-2 h-8 w-40 rounded-lg border-slate-600 text-2xl text-white bg-green-900 hover:bg-green-600"
        >
      ...
      <footer class="text-white body-font mt-3 bg-orange-100">
        <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          ...
          <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 class="title-font font-medium text-orange-600 tracking-widest text-sm mb-3">
                ABOUT Table-mate
              </h2>
              <nav class="list-none mb-10">
                <li>
                  <Link
                    className="mr-5 text-black no-underline hover:text-rose-600 focus:text-rose-600"
                    to="/about"
                  >
                    {" "}
                    About Us
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav class="list-none mb-10">
                <li>
                  <p class="text-black no-underline hover:text-gray-800">Partner With Us</p>
                </li>
                <li>
                  <p class="text-black no-underline hover:text-gray-800">Apps For You</p>
                </li>
              </nav>
            </div>
          </div>
        ...
        <div class="bg-gray-100">
          <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-gray-500  text-center sm:text-center">
              Copyright Table-Mate. All Right Reserved | Design by Student
            </p>
