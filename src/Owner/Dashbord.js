...
export default function Dashbord() {
  ...
  return (
    ...
    <div className="bg-[url('./Image/2.jpg')]  w-full h-96"><br/>
      ...
      <h5 onClick={handleOnClick} className='border-2 border-black rounded-lg h-8 w-60 cursor-pointer bg-orange-300 hover:bg-blue-600 hover:text-white'>Register Your Restaurant</h5>
      <h5 onClick={handleOnClick1} className='border-2 border-black rounded-lg h-8 w-72 cursor-pointer bg-orange-300 hover:bg-blue-600 hover:text-white ml-10'>Register Already listed? Log In</h5>
      </div>
